...
//    @Query(value = """
//    select count(r.*) from report r join location l on l.id = r.location_id
//            join users u on u.filial_id = l.filial_id where u.id = ?1
//    """, nativeQuery = true)
//    long countByFilialId(Long userId);
}
